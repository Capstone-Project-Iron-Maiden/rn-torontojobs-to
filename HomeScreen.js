  ...
  return (
    ...
    <ScrollView
      ...
      <View style={styles.logo}>
        <Image style={styles.welcomeImage} source={{ uri: `${homeJSONData.logo}` }} />
      </View>
...
function About() {
  ...
  const paragraph = homeJSONData.desc;
  ...
  return (
    <View>
      <Text style={styles.eventTime}>
        {homeJSONData.startTime + ' - '}
        {homeJSONData.endTime}
      </Text>
    </View>
  );
}
